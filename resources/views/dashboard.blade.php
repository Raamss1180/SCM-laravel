...
<head>
  ...
  <title>TofooD Admin</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('style/vendors/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{asset('style/vendors/base/vendor.bundle.base.css')}}">
  <!-- endinject -->
...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="index.html"><img src="{{asset('style/images/logo.svg')}}" class="me-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('style/images/logo-mini.svg')}}" alt="logo"/></a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Tahu</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Tempe</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">TofooD Dashboard</h4>
                </div>
                <div>
                        ...
                        <div class="col-md-6 col-xl-7">
                          <div class="table-responsive mb-3 mb-md-0">
                            <table class="table table-borderless report-table">
                              ...
                              <tr>
                                <td class="text-muted">Bandung</td>
                                <td class="w-100 px-0">
                                  <div class="progress progress-md mx-4">
                              ...
                              <tr>
                                <td class="text-muted">Surabaya</td>
                                <td class="w-100 px-0">
                                  <div class="progress progress-md mx-4">
                              ...
                              <tr>
                                <td class="text-muted">Jogjakarta</td>
                                <td class="w-100 px-0">
                                  <div class="progress progress-md mx-4">
  ...
  <script src="{{asset('style/js/jquery.cookie.js" type="text/javascript')}}"></script>
  ...
  <script src="{{asset('style/js/dashboard.js')}}{{asset('"></script>
